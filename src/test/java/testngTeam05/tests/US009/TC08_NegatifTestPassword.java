...
public class TC08_NegatifTestPassword {
    @Test
    public void test01() {
        ...
        //Hatalı password:Büyük harf , rakam ve special karakter içermeyen bir şifre girer
        commercePage.vendorPasswordSG.sendKeys(ConfigReader.getProperty("password7"),Keys.TAB,ConfigReader.getProperty("password7"),Keys.ENTER);
