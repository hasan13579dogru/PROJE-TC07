...
public class TC011_NegatifTestPassword {
    @Test
    public void test01() {
        ...
        //Hatalı password:Büyük harf , küçük harf ve rakam içermeyen bir şifre girer
        commercePage.vendorPasswordSG.sendKeys(ConfigReader.getProperty("password10"),Keys.TAB,ConfigReader.getProperty("password10"),Keys.ENTER);
