...
public class TC06_NegatifTestPassword {
    @Test
    public void test01() {
        ...
        //Hatalı password:Büyük harf ve küçük harf içermeyen bir şifre gir
        commercePage.vendorPasswordSG.sendKeys(ConfigReader.getProperty("password5"),Keys.TAB,ConfigReader.getProperty("password5"),Keys.ENTER);
