...
public class TC04_NegatifTestPassword {
    @Test
    public void test01() {
        ...
        //Hatalı password:special karakter içermeyen bir şifre girer
        commercePage.vendorPasswordSG.sendKeys(ConfigReader.getProperty("password3"),Keys.TAB,ConfigReader.getProperty("password3"),Keys.ENTER);
