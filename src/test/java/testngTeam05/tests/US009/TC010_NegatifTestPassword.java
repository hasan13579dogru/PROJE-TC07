...
public class TC010_NegatifTestPassword {
    @Test
    public void test01() {
        ...
        //Hatalı password:Küçük harf , büyük harf ve special karakter içermeyen bir şifre girer
        commercePage.vendorPasswordSG.sendKeys(ConfigReader.getProperty("password9"),Keys.TAB,ConfigReader.getProperty("password9"),Keys.ENTER);
