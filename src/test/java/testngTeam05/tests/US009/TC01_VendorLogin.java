...
public class TC01_VendorLogin {
    ...
    public void VendorLogin()
    {
        ...
        //Email için fakemail sitesine gider
        ...
        //allovercommerce sitesine geri döner
        Driver.getDriver().switchTo().window(allovercommerceHandle);
        ReusableMethods.bekle(3);

        //email bölümüne gecerli e mail adresini girer,Verification cdoe text kutusuna tıklar
