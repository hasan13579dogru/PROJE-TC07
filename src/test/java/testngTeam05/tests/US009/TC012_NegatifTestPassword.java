...
public class TC012_NegatifTestPassword {
    @Test
    public void test01() {
        ...
        //Hatalı password:Büyük harf ve rakam içermeyen bir şifre girer
        commercePage.vendorPasswordSG.sendKeys(ConfigReader.getProperty("password11"),Keys.TAB,ConfigReader.getProperty("password11"),Keys.ENTER);
