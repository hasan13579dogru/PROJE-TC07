...
public class TC09_NegatifTestPassword {
    @Test
    public void test01() {
        ...
        //Hatalı password:Küçük harf , rakam ve special karakter içermeyen bir şifre girer
        commercePage.vendorPasswordSG.sendKeys(ConfigReader.getProperty("password8"),Keys.TAB,ConfigReader.getProperty("password8"),Keys.ENTER);
