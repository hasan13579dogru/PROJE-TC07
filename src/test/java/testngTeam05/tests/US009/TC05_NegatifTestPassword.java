...
public class TC05_NegatifTestPassword {
    @Test
    public void test01() {
        ...
        //Hatalı password:Special karakter ve rakam içermeyen bir şifre girer
        commercePage.vendorPasswordSG.sendKeys(ConfigReader.getProperty("password4"),Keys.TAB,ConfigReader.getProperty("password4"),Keys.ENTER);
