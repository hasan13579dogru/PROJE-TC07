...
public class TC07_NegatifTestPassword {
    @Test
    public void test01() {
        ...
        //Hatalı password:Büyük harf içermeyen bir şifre gir
        commercePage.vendorPasswordSG.sendKeys(ConfigReader.getProperty("password6"),Keys.TAB,ConfigReader.getProperty("password6"),Keys.ENTER);
