...
public class TC03_NegatifTestPassword {
    @Test
    public void test01() {
        ...
        //Hatalı password:Büyük harf ve special karakter içermeyen bir şifre girer
        commercePage.vendorPasswordSG.sendKeys(ConfigReader.getProperty("password2"),Keys.TAB,ConfigReader.getProperty("password2"),Keys.ENTER);
