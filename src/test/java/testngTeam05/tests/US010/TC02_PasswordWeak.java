...
public class TC02_PasswordWeak {
    @Test
    public void test01() {
        ...
        commercePage.vendorPasswordSG.sendKeys(ConfigReader.getProperty("password14"),Keys.TAB,ConfigReader.getProperty("password14"),Keys.ENTER);
