package testngTeam05.tests.US010;
...
public class TC01_PasswordToShort {
    @Test
    public void test01() {
        ...
        commercePage.vendorPasswordSG.sendKeys(ConfigReader.getProperty("password13"),Keys.TAB,ConfigReader.getProperty("password13"),Keys.ENTER);
        commercePage.tooShort.isDisplayed();
