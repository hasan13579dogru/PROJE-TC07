...
public class TC_02_kayitliLogin extends ExtentReport {
    /*
    ...
    public void test02() {
        ...
        extentTest.info("'I agree to the privacy policy' butonu tiklandi");

        alloverCommercePage.registerSignUp.click();
        extentTest.info("SignUp butonu tiklandi");

        Assert.assertTrue(alloverCommercePage.pleaseLoginYazisi.isDisplayed());
        extentTest.info("'An account is already registered with your email address.' mesaji goruldu");

        ReusableMethods.tumSayfaResmi("Please log in mesaji goruldu");
